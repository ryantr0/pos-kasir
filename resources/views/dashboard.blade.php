...
<body class="bg-[#f8fafc] antialiased text-slate-900" x-data="{ open: false }">
    <div class="flex min-h-screen relative">
        ...
        <aside 
            ...
            class="fixed inset-y-0 left-0 z-50 w-64 lg:relative flex-shrink-0 border-r border-slate-200 bg-white transition-transform duration-300 ease-in-out flex flex-col">
        ...
        <main class="flex-1 overflow-y-auto min-w-0">
            <header class="h-20 flex items-center justify-between px-4 lg:px-8 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40">
                <div class="flex items-center gap-4">
                    <button @click="open = !open" class="lg:hidden p-2 rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-200 transition-colors">
