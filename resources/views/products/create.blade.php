...
<div class="flex min-h-screen">
    ...
    <div>
        ...
        <nav class="flex-1 px-4 space-y-2 mt-4">
            <div class="px-3 py-2 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-1">Menu Utama</div>
        ...
        <div class="p-4 border-t border-slate-100">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-full py-2 border border-slate-200 text-xs font-bold text-slate-600 hover:bg-red-50 hover:text-red-600 rounded-lg transition-all uppercase tracking-widest">LOGOUT</button>
            </form>
        </div>
    </aside>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="5" placeholder="Berikan deskripsi produk yang menarik..."
